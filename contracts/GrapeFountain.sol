...
// Adapted from MasterVintnerJoeV2 and Police And Thieves Vault
// Added a variable reward rate based on the total LP staked
contract GrapeFountain is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public initialLPValue; // Initial number of LP tokens of AVAX-VINTAGEWINE
    ...
    // Deposit LP tokens to MasterVintner for Reward allocation.
    ...
    // Withdraw LP tokens from MasterVintner.
